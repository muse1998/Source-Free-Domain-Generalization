#!/usr/bin/env bash
# ResNet50, PACS
# CUDA_VISIBLE_DEVICES=0 python clipdg.py data/PACS -d PACS -s A C S -t P -a resnet50 --freeze-bn --seed 0 --log logs/erm/PACS_P &
# CUDA_VISIBLE_DEVICES=0 python clipdg.py data/PACS -d PACS -s P C S -t A -a resnet50 --freeze-bn --seed 0 --log logs/erm/PACS_A &
# CUDA_VISIBLE_DEVICES=1 python clipdg.py data/PACS -d PACS -s P A S -t C -a resnet50 --freeze-bn --seed 0 --log logs/erm/PACS_C &
# CUDA_VISIBLE_DEVICES=1 python clipdg.py data/PACS -d PACS -s P A C -t S -a resnet50 --freeze-bn --seed 0 --log logs/erm/PACS_S

# # ResNet50, Office-Home
CUDA_VISIBLE_DEVICES=0 python clipdg.py data/office-home -d OfficeHome -s Ar Cl Rw -t Pr -a resnet50 --seed 0 --log logs/erm/OfficeHome_Pr
...
# # ResNet50, DomainNet
# CUDA_VISIBLE_DEVICES=1 python clipdg.py data/domainnet -d DomainNet -s i p q r s -t c -a resnet50 -i 2500 --lr 0.01 --seed 0 --log logs/erm/DomainNet_c
